<template >
    <div>
        <div class="modal fade" ref='deleteModal' tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" >
...
<script>
    ...
    export default {
        ...
        mounted(){
            $(this.$refs.deleteModal).on('hidden.bs.modal', function (e) {
